...
Поэтому эмблема на странице **типографическая**: набрана по названию сети средствами CSS. Оригинальный логотип должен прийти от них — в вектор его подставить дело пяти минут.
